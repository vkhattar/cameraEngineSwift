...
extension UIDevice {
    static func orientationTransformation() -> CGFloat {
        ...
        print("this will save your life")
        var  ori : UIInterfaceOrientation
...
class CameraEngineVideoEncoder {
    ...
    private func initVideoEncoder(url: NSURL) {
        ...
        self.videoInputWriter.transform =  CGAffineTransformConcat(CGAffineTransformMakeScale(1, -1), CGAffineTransformMakeRotation(UIDevice.orientationTransformation()))
        

        
//        self.videoInputWriter.
